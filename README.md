# HitTechBlogV2: A Cloudflare D1 and Cloudflare Pages based Deploy-and-Maintain-Cost-Free Cloud-based Note-taking and Blog System, supporting both Image and Rich-text, responsive for PC and Mobile Phone
## 0. Demo
